...
import com.bpv.vmapplication.databinding.FragmentShareTwoBinding
import com.bpv.vmapplication.share.vm.ActivityShareViewModel

class TwoShareFragment : Fragment() {

    private val viewModel by activityViewModels<ActivityShareViewModel>()

    private var _binding: FragmentShareTwoBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentShareTwoBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnNext.setOnClickListener {
            findNavController().navigate(R.id.action_twoShareFragment3_to_threeShareFragment2)
        }
