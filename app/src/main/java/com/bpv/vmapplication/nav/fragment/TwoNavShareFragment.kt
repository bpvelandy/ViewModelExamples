...
import com.bpv.vmapplication.databinding.FragmentNavShareTwoBinding
import com.bpv.vmapplication.nav.vm.NavShareViewModel

class TwoNavShareFragment : Fragment() {

    private val viewModel by navGraphViewModels<NavShareViewModel>(R.id.navigation)

    private var _binding: FragmentNavShareTwoBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentNavShareTwoBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnNext.setOnClickListener {
            findNavController().navigate(R.id.action_twoNavShareFragment_to_threeNavShareFragment)
        }
